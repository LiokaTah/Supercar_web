...
<body>
    ...
    <form id="formulaire-filtres">
        ...
        <div class="filtre-groupe">
            ...
            <input type="number" id="filtre-annee" name="annee" min="1950" max="2025" placeholder="Ex: 2018">
        </div>

        <div class="filtre-groupe">
            <label for="filtre-prix-max">Prix Max :</label>
            <input type="range" id="filtre-prix-max" name="prix_max" min="50000" max="5000000" step="50000" value="5000000">
            <span id="prix-affichage">5,000,000 $</span>
        </div>
    ...
    <footer>
        <p>&copy; 2025 Supercar Projecte - Tous droits réservés.</p>
    </footer>
